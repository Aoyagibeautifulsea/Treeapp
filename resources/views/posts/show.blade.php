                    ...
                    <div class="bg-white border border-gray-300 shadow-md rounded-md p-4">
                        <div class='post'>
                            <h2 class='title text-lg'>
                                <a href="/posts/{{ $source_story->id }}" class="text-gray-800 hover:underline">{{ $source_story->title }}</a>
                            </h2>
                        </div>
                                ...
                                @forelse($tag->posts->where('id', '<>', $post->id)->shuffle()->take(4) as $relatedPost)
                                    @if ($relatedPost->id !== $post->id)
                                        <div class="bg-white border border-gray-300 shadow-md rounded-md p-4">
                                            <div class='post'>
                                                <h2 class='title text-lg'>
                                                    <a href="/posts/{{ $relatedPost->id }}" class="text-gray-800 hover:underline">{{ $relatedPost->title }}</a>
                                                </h2>
                                            </div>
                                            <div class='creator mt-2'>
                                                <h3 class='creator text-gray-600'>
