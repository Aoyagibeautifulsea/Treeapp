        ...
        <div class="text-lg font-bold text-gray-800">いいねした投稿</div>
            <div id='postContainer' class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                @else
                    <p>まだいいねした作品がありません</p>
                @endif
            <button id="loadMoreButton" class="bg-gray-500 hover:bg-gray-600 focus:outline-none text-white py-2 px-4 rounded-full">もっと見る</button>
        </div>
